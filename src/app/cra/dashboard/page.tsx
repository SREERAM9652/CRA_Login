...
export default function CRADashboardOverview() {
  ...
  return (
    <div className="space-y-8 font-sans">
      ...
      {/* ========================================================================= */}
      <div className="rounded-2xl bg-gradient-to-r from-[#1e1b4b] via-[#2e1f74] to-[#382685] text-white shadow-lg border border-white/10 overflow-hidden relative p-4 sm:p-5">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 relative z-10">
          ...
          <div className="space-y-1 max-w-lg">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-blue-200/80 font-medium">Earn 30% on every customer test</span>
            </div>
            <h2 className="text-lg sm:text-xl font-black tracking-tight text-white">
              Share with Customers & Earn 30%
            </h2>
            <p className="text-xs text-blue-100/90 leading-snug font-medium">
              Customers get a flat <strong>20% discount</strong> on tests, and <strong>30% of the booking price</strong> is credited directly to you.
            </p>
          </div>

          {/* Compact Code Copy & Share Box */}
          <div className="bg-slate-950/70 backdrop-blur-md p-2.5 sm:p-3 rounded-xl border border-white/15 flex flex-wrap sm:flex-nowrap items-center gap-2.5 shadow-xl shrink-0">
            <div className="px-3 py-1.5 bg-white/10 rounded-lg border border-white/10 text-center sm:text-left">
              <div className="text-[9px] text-cyan-300 font-extrabold uppercase tracking-wider">Your Code</div>
              <div className="font-mono text-base sm:text-lg font-black tracking-wider text-white leading-none mt-0.5">{referralCode}</div>
            </div>
        ...
        {/* Compact Footer Formula */}
        <div className="mt-3 pt-2.5 border-t border-white/10 flex flex-wrap items-center justify-between gap-2 text-[11px] text-blue-200/90 relative z-10">
          <div className="flex items-center gap-1.5 font-mono text-[10.5px]">
            <span className="px-1.5 py-0.5 rounded bg-white/10 text-[9.5px]">How it works:</span>
            <span>Customer Price = MRP - 20% Off • Your Direct Earning = 30% of Customer Price</span>
          </div>
          <span className="text-cyan-300 font-bold text-[10.5px] flex items-center gap-1">
            <CheckCircle2 className="h-3 w-3 text-emerald-400" /> Bank Payouts Every 1st & 15th
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="p-6 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all">
          ...
          <div className="text-3xl font-black text-slate-900">{totalReferrals}</div>
        ...
        <div className="p-6 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all">
          ...
          <div className="text-3xl font-black text-slate-900">{activeCustomers}</div>
        ...
        <div className="p-6 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all">
          ...
          <div className="text-3xl font-black text-slate-900">₹{totalRealizedRevenue.toLocaleString()}</div>
          <div className="text-xs text-slate-500 mt-1.5 font-medium">
        ...
        {/* Card 4 */}
        <div className="p-6 rounded-3xl bg-white border-2 border-purple-200/80 shadow-md hover:shadow-lg transition-all bg-gradient-to-br from-white to-purple-50/40">
          <div className="flex items-center justify-between mb-2">
          ...
          <div className="text-3xl font-black text-[#251b5c]">₹{Math.round(totalIncentivesEarned).toLocaleString()}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 sm:p-7 border border-slate-100 shadow-sm space-y-4">
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between text-xs text-slate-500 gap-2 font-medium">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-purple-50/60 to-indigo-50/40 rounded-3xl p-5 border border-purple-200/60 shadow-xs space-y-3">
            <div className="flex items-center gap-3">
      ...
      <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 sm:p-7 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-3">
          ...
          <Link
            href="/cra/dashboard/referrals"
            className="text-xs font-black text-[#382685] hover:underline inline-flex items-center gap-1"
          >
